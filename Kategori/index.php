...
<body>
    <div class="container mt-5">
        ...
        <div class="text-right mb-3">
            <a href="create.php" class="btn btn-success">Add Kategori</a>
            ...
            <tbody>
                <?php foreach ($kategoris as $kategori): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?= $kategori['id_kategori'] ?>" class="btn btn-warning">Edit</a>
                            <a href="delete.php?id=<?= $kategori['id_kategori'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this kategori?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
